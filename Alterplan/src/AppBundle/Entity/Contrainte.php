 ...
 * @ORM\Entity
 */
class Contrainte implements \JsonSerializable
{
    /**
     * @var integer
     *
    ...
    {
        $result = array();
        $result['codeContrainte'] = $this->codeContrainte;
        $result['DateCreation'] = $this->dateCreation;
        $result['P1'] = $this->p1;
        $result['P2'] = $this->p2;
        if ($this->getCalendrier() != null) {
            $result['codeCalendrier'] = $this->getCalendrier()->getCodeCalendrier();
        }
        if ($this->getTypeContrainte() != null) {
            $result['typeContrainte'] = $this->getTypeContrainte()->jsonSerialize();
        };
        return $result;
    }
}
